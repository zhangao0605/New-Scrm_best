...
@Component({
  selector: 'app-tencentnews',
  templateUrl: './tencentnews.component.html',
  styleUrls: ['./tencentnews.component.css']
})
export class TencentnewsComponent implements OnInit {
	ismask=false;
	tencentext="";
	tencenshejiao="";
  tencentshe=false;
  ...
  cycle='A1';
   //选择社交号
	  ...
	  rightData=[];
	  wechatid='';
	  immediately:string=GlobalUrl.prioductUrl +'personification/checkTencentNews';
		  	 	      ...
		  	 	      var shejiaoids='';
		  	 	       for(var i=0;i<this.rightData.length;i++){
					       ...
					       shejiaoids=shejiaoids.substring(0,shejiaoids.length-1);
					        ...
					        this.tencenshejiao=str;
						  	  this.tencentshe=false;
						  	  this.ismask=false;
						  	  this.rightData=[];
						  	  	this.sjinputmodel='';
						  	  for(var i=0;i<this.shejarr.length;i++){
   ...
   tencensure(){
           ...
           //任务名称
    	      if(this.tencentext==''){
    	      	...
    	      	formdata1.append('taskName',this.tencentext);
    	      }
    	      //社交号
    	      if(this.wechatid==''){
					  	 alert("请选择社交号");
