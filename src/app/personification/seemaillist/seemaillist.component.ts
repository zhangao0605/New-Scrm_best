...
@Component({
  selector: 'app-seemaillist',
  templateUrl: './seemaillist.component.html',
  styleUrls: ['./seemaillist.component.css']
})
export class SeemaillistComponent implements OnInit {
	ismask=false;
  lushe=false;
  mailtext="";
	mailshejiao="";
  ...
  cycle='A1';
   //选择社交号
	  ...
	  rightData=[];
	  wechatid='';
	  immediately:string=GlobalUrl.prioductUrl +'personification/checkAddressBook';
   ...
   mailsure(){
            ...
            formdata1.append('accountId',localStorage.getItem('id'));
    	      ...
    	      if(this.mailtext==''){
    	      	...
    	      	formdata1.append('taskName',this.mailtext);
    	      }
    	      //社交号
    	      if(this.wechatid==''){
					  	 alert("请选择社交号");
