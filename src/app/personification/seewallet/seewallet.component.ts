...
@Component({
  selector: 'app-seewallet',
  templateUrl: './seewallet.component.html',
  styleUrls: ['./seewallet.component.css']
})
export class SeewalletComponent implements OnInit {
  ...
  rightData=[];
  wechatid='';
  immediately:string=GlobalUrl.prioductUrl +'personification/seeTheWallet';
	  	 	      ...
	  	 	      var shejiaoids='';
	  	 	       for(var i=0;i<this.rightData.length;i++){
				       ...
				       shejiaoids=shejiaoids.substring(0,shejiaoids.length-1);
				        ...
				        this.walletshejiao=str;
					  	  this.seewallshe=false;
					  	  this.ismask=false;
					  	  this.rightData=[];
					  	  	this.sjinputmodel='';
					  	  for(var i=0;i<this.shejarr.length;i++){
   ...
   walletsure(){
            ...
            //任务名称
    	      if(this.wallettext==''){
    	      	...
    	      	formdata1.append('taskName',this.wallettext);
    	      }
    	      //社交号
    	      if(this.wechatid==''){
					  	 alert("请选择社交号");
