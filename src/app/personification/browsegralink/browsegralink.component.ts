...
@Component({
  selector: 'app-browsegralink',
  templateUrl: './browsegralink.component.html',
  styleUrls: ['./browsegralink.component.css']
})
export class BrowsegralinkComponent implements OnInit {
	ismask=false;
  browshe=false;
  browsetext="";
	browseshejiao="";
  ...
  rightData=[];
  wechatid='';
  immediately:string=GlobalUrl.prioductUrl +'personification/viewGraphicLink';
   ...
   browsesure(){
            ...
            formdata1.append('accountId',localStorage.getItem('id'));
    	      ...
    	      if(this.browsetext==''){
    	      	...
    	      	formdata1.append('taskName',this.browsetext);
    	      }
    	      //社交号
    	      if(this.wechatid==''){
					  	 alert("请选择社交号");
